...
####  Data
This code requires all necessary data to be placed/linked under `data` folder in the following structure. *For completeness and ease of demo only*, we provide these for **download from [HERE](https://figshare.com/s/7126af78403466e87a81). 
